...
def generate_excel(df: pd.DataFrame) -> BytesIO:
    ...
    cols = ['Артикул', 'SKU', 'Название_товара', 'Продано_шт', 'Выручка',
            'Общие_расходы', 'Чистая_прибыль', 'Остаток', 'Продаж_в_день',
            'Расход_на_рекламу', 'Себестоимость', 'Итог_прибыль']
    ...
    with pd.ExcelWriter(output, engine='openpyxl') as w:
        ...
        pd.DataFrame({'Инструкция': [
            ...
            '2. Итог_прибыль = Чистая_прибыль - Расход_на_рекламу - Себестоимость'
